...
urlpatterns = [
    ...
    path('documents/<int:doc_id>/files/<int:file_id>/view-token', document_views.get_file_view_token),
    ...
    path('library/folders/<int:folder_id>/permissions', library_views.folder_permissions),
    path('library/folders/<int:folder_id>/permissions/<int:user_id>', library_views.folder_permission_detail),
    path('library/folders/<int:folder_id>/request-access', library_views.request_folder_access),
    path('library/doc-types/<int:doc_type_id>/documents', library_views.doc_type_documents),
    path('library/access-requests/inbox', library_views.access_requests_inbox),
    path('library/access-requests/mine', library_views.my_access_requests),
